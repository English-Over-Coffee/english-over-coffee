...
t = Teacher.create(email: "william.shakespeare@teacher.com",
                   password: "password",
...
l = t.locations.create(name: "Tokyo People's Cafe",
...
t = Teacher.create(email: "tupac.shakur@teacher.com",
                   password: "password",
                   password_confirmation: "password",
                   first_name: "Tupac",
                   last_name: "Shakur",
...
l = t.locations.create(name: "cafe The SUN LIVES HERE",
...
t = Teacher.create(email: "goku@teacher.com",
                   password: "password",
                   password_confirmation: "password",
                   first_name: "Goku",
                   last_name: "",
...
l = t.locations.create(name: "Rainbow Pancake Cafe",
...
t = Teacher.create(email: "newman@teacher.com",
                   password: "password",
                   password_confirmation: "password",
                   first_name: "Newman",
                   last_name: "",
